 ...
 */
require_once 'Lexsign/Queue/Adapter/Mongo/Message.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Lexsign_Queue_Adapter_Mongo extends Zend_Queue_Adapter_AdapterAbstract {
     ...
     */
    protected function _initMongoAdapter() {
        ...
        if (!array_key_exists('db', $options)) {
            require_once 'Zend/Queue/Exception.php';
            throw new Zend_Queue_Exception("Configuration array must have a key for 'db' for the password to use");
        }

        try {
            $mongo = new Lexsign_Queue_Adapter_Mongo_Message();
